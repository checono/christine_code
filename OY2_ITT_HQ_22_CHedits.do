...
log using OY2_ITT_22_CHedits_${date}.txt, replace

use "S:\Shared\AShangraw\data\2015_07\compressedFull\DID_2015_07_MSR22_SPLIT.dta", clear

* Use only a 10% sample of this dataset; this 10% sample will be restored each time
sample 10
...
regress  mpayinp i.hbpci i.post BPCI BPCI_case i.pvdr i.qtr $covariates , vce(cluster hosp_qrt) 
qreg  mpayinp hbpci post BPCI BPCI_case $covariates ipvdr2-ipvdr52 iqtr2-iqtr13 , q(0.5)  nolog 
