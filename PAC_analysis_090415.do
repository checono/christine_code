...
foreach x in 11 12 13 14 {
	...
	use data\mds_asmt3`x'_r4396, clear
	desc
...
use data\pac_data_2011, clear
append using data\pac_data_2012
append using data\pac_data_2013
append using data\pac_data_2014
...
merge m:1 clm_drg_cd using Data\UpdatedMSDRGGroups_20150818_xWalk, keepusing(clm_drg_group)	
