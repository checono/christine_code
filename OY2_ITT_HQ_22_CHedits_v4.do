...
cap log close
set logtype text
log using OY2_ITT_22_CHedits_v4_${date}.txt, replace
...
save "S:\Shared\ARNV\OY\OY2\ITT\temp.dta", replace
clear 
*********************************************************************************************
/*
tab pvdr , gen(ipvdr)
...
*foreach w in all active exits PHC expan targ {
foreach w in exits {
use "S:\Shared\ARNV\OY\OY2\ITT\temp.dta", clear
*preserve
display "Sample is `w'"
keep if `w'==1
tab pvdr , gen(Xpvdr)
...
graph export "S:\Shared\ARNV\OY\OY2\ITT\qreg_`w'_BPCI_case_22_v4.png", as(png) replace


lowess mpayinp BPCI_case  , bwidth(0.1)
graph export "S:\Shared\ARNV\OY\OY2\ITT\LOWESS_`w'_BPCI_case_22all_v4.png", as(png) replace
lowess mpayinp BPCI_case if BPCI_case>0 , bwidth(0.1)
graph export "S:\Shared\ARNV\OY\OY2\ITT\LOWESS_`w'_BPCI_case_22pos_v4.png", as(png) replace
